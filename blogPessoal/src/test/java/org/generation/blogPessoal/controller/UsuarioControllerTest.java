...
public class UsuarioControllerTest {
	...
	public void naoDevePublicarUsuario() {
		usuarioService.cadastrarUsuario(new UsuarioModel(0L,
				"Maria da Silva", "maria_silva@email.com.br", "12345678", "https://i.imgur.com/T12Nip9.jpg"));
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new UsuarioModel(0L,
				"Ricardo Marques", "ricardo_marques@email.com", "ricardo123", "https://i.imgur.com/Sk5SjWE.jpg"));
